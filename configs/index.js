...
const { MONGO_CONNECT_URL, PORT, FRONT_END_URL, FORGOT_PASSWORD_FRONT_END_URL, ACTIVATE_ACCOUNT_FRONT_END_URL,
    ...
    TRANSPORTER_SENDER_EMAIL, TRANSPORTER_SENDER_PASS, NODE_ENV, ALLOWED_ORIGIN, DEFAULT_ADMIN_PASSWORD } = require('./config');

const { PASSWORD_REGEXP, EMAIL_REGEXP, AUTHORIZATION, CREATED_STATUS, NO_CONTENT_STATUS, BAD_REQUEST_STATUS,
    DEFAULT_STATUS_ERR, LOGGED_OUT, USER_ACTIVATED, WRONG_TEMPLATE_NAME, CORS_NOT_ALLOWED } = require('./constants');

const { CHANGE_USER_PASSWORD, DELETED_USER, DELETED_UNACTIVATED_ACCOUNT, REGISTERED_USER, REMIND_ACTIVATE_ACCOUNT,
    REMIND_LOGIN, REMIND_PUBLICATIONS, NEW_USER_PASSWORD, UPDATED_USER } = require('./email-actions.enum');
